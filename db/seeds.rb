...
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: "Read a screw post about blood types and exposed my family's history of not knowing who tf my dad's mother is #screw #einstein #lovemylife #icanexplain", category: family_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.reactions.create(user: cvo_cofounder)
post.reactions.create(user: golden_boy)
...
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: " I was too much of a coward to admit to my aunt that we had to stay in a love hotel and instead tried to pretend everything was fine and normal. Everything was not, in fact, fine and normal. #screw #einstein #lovemylife #icanexplain", category: family_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.reactions.create(user: cvo_cofounder)
post.reactions.create(user: golden_boy)
...
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: "Told my aunt her BF was cheating on her after months of knowing, hell broke, needed stitches. #screw #einstein #lovemylife #icanexplain", category: family_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.reactions.create(user: cvo_cofounder)
post.reactions.create(user: golden_boy)
...
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: "I screwed up by giving my 5 years old nephew homemade alcohol by accident and not telling my sister #screw #einstein #lovemylife #icanexplain", category: family_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.reactions.create(user: cvo_cofounder)
post.reactions.create(user: golden_boy)
...
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: "I pranked my Uncle by claiming we were taught Robert E Lee had a crush on Abraham Lincoln and joined the Confederacy with this as his motivation, and that he also had a sexual affair with General Pickett. #screw #einstein #lovemylife #icanexplain", category: family_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.comments.create(user: cool_girl, content: "This too shall pass")
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: "Tried to tell my grandmother 'talk to you later' in her language, said 'death' to her instead. Yeah it was the first word I said to her in her native language. #screw #einstein #lovemylife #icanexplain #familyguy", category: family_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.reactions.create(user: cvo_cofounder)
post.reactions.create(user: golden_boy)
...
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: "My daughter bought fake flower gravestone arrangements for her grandmothers who are both very much alive, for Mother's Day. #screw #einstein #lovemylife #icanexplain #familyguy", category: family_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.reactions.create(user: cvo_cofounder)
post.reactions.create(user: golden_boy)
...
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: "I almost die because of being too polite and eating too much of my grandma's food. #screw #einstein #lovemylife #icanexplain #familyguy", category: family_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.reactions.create(user: cvo_cofounder)
post.reactions.create(user: golden_boy)
...
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: "Took a backhoe to my parents house, dug up a 45 year old cooler with liquified deer carcasses in it, and made an entire neighborhood smell like death for days. #screw #lovemylife #icanexplain #familyguy", category: family_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.reactions.create(user: cvo_cofounder)
post.reactions.create(user: golden_boy)
...
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: "My father-in-law recently had a birthday and I really screwed up with the gift failing to find anything suitable for him. He always gives me amazing records, but when I gave him a beer brewing set he was really disappointed. #screw #lovemylife #icanexplain #familyguy", category: family_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.reactions.create(user: cvo_cofounder)
post.reactions.create(user: golden_boy)
