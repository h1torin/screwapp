...
fun_person = User.create(email: "straw@me.com", password: "123456", nickname: "MistyBear807", emoji: "🥸", background_color: "red")
...
post.comments.create(user: family_guy, content: "Oh no! I feel so sorry for you")
puts "Finished category"
post = Post.create(user: family_guy, content: "my garage automatically closed, trapping a curious cat who then set off our alarm system and pooped in the garage.", category: household_category, created_at: DateTime.now - (rand * 8))
post.reactions.create(user: cool_girl)
post.reactions.create(user: family_guy)
post.reactions.create(user: cvo_cofounder)
post.reactions.create(user: golden_boy)
